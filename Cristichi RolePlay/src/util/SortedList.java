...
public class SortedList<T> extends ArrayList<T> {
	...
	/**
	 * Construct a new instance containing the elements of the specified collection
	 * with the list elements sorted in their {@link java.lang.Comparable} natural
	 * ordering.
	 * 
	 * @param collection
	 */
	...
	/**
	 * Construct a new instance containing the elements of the specified collection
	 * with the list elements sorted using the given comparator.
	 * 
	 * @param collection
	 * @param comparator
	 */
	...
	/**
	 * Adds all elements in the specified collection to the list. Each element will
	 * be inserted at the correct position to keep the list sorted.
	 * 
	...
	public static Level getLevel(SortedList<Level> levels, int exp) {
		try {
