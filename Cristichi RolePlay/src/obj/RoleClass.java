...
public enum RoleClass {
	BEGGAR("Beggar", "You aren't much at the start but you will level up easier.", "You gain experience while walking.", CrisPlay.mainColor + "[Beggar]" + ChatColor.RESET),
	WARRIOR("Warrior", "Hitting things is your way to go.", "You gain experience when you hit mobs or players.", CrisPlay.mainColor + "[Warrior]" + ChatColor.RESET),
	TANK("Tank", "You will die fighting or fight without dying at all.", "You gain experience when you get hit.", CrisPlay.mainColor + "[Tank]" + ChatColor.RESET),
	ARCHER("Archer", "I hope you have a bow in your pocket, or tons of snowballs.", "You gain experience when you hit mobs or players using a bow or throwing snowballs, eggs, etc.", CrisPlay.mainColor + "[Archer]" + ChatColor.RESET),
	FISHERMAN("Fisherman", "It's not the most interesting job, but you enjoy it.", "You gain experience when you fish.", CrisPlay.mainColor + "[Fisherman]" + ChatColor.RESET),
	RIDER("Rider", "Walking is for duumies.", "You gain experience while moving on minecarts, boats, horses, etc.", CrisPlay.mainColor + "[Rider]" + ChatColor.RESET),
	;
	static {
